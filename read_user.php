...
$query = "SELECT * FROM user WHERE userid = " . $_SESSION['userid']; // make a sql query
$user = mysqli_query($db_connection, $query); // run query & result quert is array
...
<body>
    ...
    <div class="main-content1">
        ...
        <table border="1">
            ...
            foreach ($user as $data) : //loop to extract data from database / loop data array
            ?>
                <tr>
                    <td><?php echo $i++; ?></td>
